...
//            }
    ...
    public void onMap1 (View view) {




        ImageView ubc = (ImageView) findViewById(R.id.imageView);
        ubc.setVisibility(View.VISIBLE);
    ...
    public void onUBC (View view) {

            ImageView ubc = (ImageView) findViewById(R.id.imageView);
            ubc.setVisibility(View.INVISIBLE);
